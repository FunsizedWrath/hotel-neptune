...
<div class="color">
    ...
    <div class="chambre-royal">
        <div class="d-flex">
            ...
            <div class="chambre-contenu">
                <div class="d-flex">
                    <h3><u><b>Chambre des Mystères</u></b></h3>

                    <span> <b id="surface">65m²</b> <br><b>à partir de 215€</b></span>
                </div>
                <div class="description">
                <p>
                    Votre sommeil sera agréablement accompagné par l'ambiance relaxante de la chambre et ses couleurs taupes.
    ...
    <div class="chambre-royal">
        <div class="d-flex">
            ...
            <div class="chambre-contenu">
                <div class="d-flex">
                    <h3><u><b>Chambre des Fées</u></b></h3>

                    <span> <b id="surface">70m²</b> <br><b>à partir de 220€</b></span>
                </div>
                <div class="description">
                <p>
                    Votre sommeil sera agréablement accompagné par cette douce ambiance forestière.
    ...
    <div class="chambre-royal">
        <div class="d-flex">
            ...
            <div class="chambre-contenu">
                <div class="d-flex">
                    <h3><u><b>Chambre des Mélodies</u></b></h3>

                    <span> <b id="surface">82m²</b> <br><b>à partir de 230€</b></span>
                </div>
                <div class="description">
                <p>
                    Votre sommeil sera agréablement accompagné par cette douce ambiance épuré et très agréable.
                    Depuis la fenêtre de votre chambre vous pourrez apercevoir et entendre le doux chant de la mer. Vous pouvez accéder à la terrasse suitué dans le salon, qui offre une agréable vue des étoiles le soir. <br> <br>
        ...
        <div class="d-flex">
            ...
            <div class="chambre-contenu">
                <div class="d-flex">
                    ...
                    <span> <b id="surface">85m²</b> <br><b>à partir de 235€</b></span>
                </div>
                <div class="description">
                <p>
                    Votre sommeil sera agréablement accompagné par la clarté de la lune et ses étoiles.
